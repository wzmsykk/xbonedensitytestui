...
ApplicationWindow {
    ...
    function showHiddenSettings() {
        ...
        hideConn.enabled = true
        hideConn.target = popupLoader.item
        ...
        Rectangle {
            ...
            Label {
                ...
                MouseArea {
                    ...
                    anchors.fill: parent
                    onClicked: {
                        if (hiddenSetTimer.running === false)
                            hiddenSetTimer.restart()
                        hiddenSetCount++
                        if (hiddenSetCount >= 5) {
                            hiddenSetTimer.stop()
                            hiddenSetCount = 0
                ...
                Loader {
                    ...
                    Connections {
                        ...
                        onAccepted: {
                            ...
                            popupLoader.push("../pages/WorkPage.qml","show")
